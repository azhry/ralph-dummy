...
- [x] Set up MongoDB connection layer
- [x] Create domain models and repository interfaces
- [x] Implement JWT authentication system
- [x] Create user management system
- [x] Implement basic wedding CRUD operations
...
- [x] Implement wedding CRUD operations
- [x] Implement wedding service layer with business logic
- [x] Create wedding service unit tests
- [x] Create wedding handler unit tests
- [x] Integrate auth handlers into main application
- [x] Create wedding service unit tests
- [x] Create wedding handler unit tests
