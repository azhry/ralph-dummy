...
type User struct {
	...
	Name                   string               `bson:"name" json:"name"` // Computed field for compatibility
	...
	Status                 UserStatus           `bson:"status" json:"status" validate:"required,oneof=active inactive unverified suspended"`
